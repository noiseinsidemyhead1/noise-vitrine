...
export default function Home() {
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center bg-background text-foreground">
      <ModelViewer />

      <main className="relative z-10 mx-auto flex w-full max-w-5xl items-center justify-center px-6 py-16 -translate-y-6 sm:-translate-y-8 lg:-translate-y-10">
            ...
            <div className="mt-6 flex flex-col items-center gap-6 md:flex-row md:items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="mt-3 text-sm leading-7">
                  currently: clearing extreme demons on Geometry Dash, boosting TFT across every elo, playing pokemon white 2, and digging deeper into Linux.
                </p>
